...
echo -e "=========Service-Port========="
echo -e "SlowDNS: 443,22,109,143" "OHP SSH: 8181" "OVPN Websocket: 2086"
echo -e "SSH Websocket SSL/TLS: 443" "OHP Dropbear: 8282" "OHP OpenVPN: 8383"
echo -e "SSH Websocket HTTP: 8880" "OVPN Port TCP: $ovpn" "OVPN Port UDP: $ovpn2"
echo -e "BadVPN UDPGW: 7100,7200,7300" "OVPN Port SSL: 990"
